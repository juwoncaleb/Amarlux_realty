    ...
    <div>
     <div>
      <div className="discover_div">
        ...
        <div>
          <p className="head_text hero_subliminary">
            LUXURIOUS HOMES AWAIT- EXPLORE AN ARRAY OF EXQUISITE PROPERTIES FOR
      ...
      <div className="bg-black exclusive_listing">
        <p className="text-center exclusive_header mb-20">Exclusive Listing</p>
      ...
      <div className="landingpage_about flex justify-around gap-10">
        ...
        <div className="abt_amara">
          ...
          <p>
            Amarachi connections to the top 1% of the industry afford her access to
            the most coveted properties, many of which are never listed in the
            highly competitive Lagos luxury market.
          </p>
          <p className="mt-8">
            Amarachi attributes her success to her effective working relationships
            ...
            for Amarachi, a life-long relationship with a client brings her genuine
      ...
      <div>
        ...
        <div className="flex frame_div gap-10 mt-20">
          <div>
            ...
            <p className="blog_header">Real Estate Developers Announce Plans for Innovative Mixed-Use Project</p>
          </div>
